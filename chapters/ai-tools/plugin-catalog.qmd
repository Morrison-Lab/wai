...
per [when to use AI](coding-agents.qmd#sec-ai-when-to-use).
...
and [PR activity notifications](pr-workflow-with-agents.qmd#sec-ai-pr-activity-notifications) what it adds.
...
(measured 2026-09-09),
plus memories and the `shared/` fragments this site vendors into [fully clean](pr-workflow-with-agents.qmd#sec-fully-clean) and its neighbours.
...
and its terminal condition is [fully clean](pr-workflow-with-agents.qmd#sec-fully-clean),
