...
and [coding-agent platforms](coding-agents.qmd#sec-ai-coding-agent-platforms) lists common platforms as a starting point.
...
([other models](local-models.qmd#sec-ai-claude-code-other-models) covers the same rule from the Claude Code side),
...
[Running coding agents offline](local-models.qmd#sec-ai-offline) and [small local models](local-models.qmd#sec-ai-small-local-models) cover the mechanics and the model choice.
