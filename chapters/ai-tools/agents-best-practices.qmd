...
3. **Test thoroughly**:
   ...
   Budget for it, too:
   practitioners reporting on agent-built projects independently identify manual testing as the dominant cost once generation is cheap,
   and a defect-free result takes either deep domain experience or heavy testing.
