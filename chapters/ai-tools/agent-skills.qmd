...
A skill is one of several ways to customize an agent,
and not always the right one.
@sec-ai-customization compares it against instruction files,
subagents,
hooks,
and permissions,
and explains why Claude Code's custom slash commands are now skills themselves.
...
including user-level skills, hooks, and subagents, synced across machines via Git.
