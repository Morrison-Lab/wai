...
It needs Node.js 22.17 or later,
and by default it checks for updates every three hours
and installs them silently.
...
though it states it has not done so.
...
where they are version-controlled, reviewed in pull requests,
