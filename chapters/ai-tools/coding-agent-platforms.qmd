...
| [OpenCode](https://opencode.ai) [@opencode_docs] | Terminal, desktop app, and IDE extension | Bring your own model provider (including local endpoints; see [connecting OpenCode to local models](local-models.qmd#sec-ai-opencode-ollama)) and edit the local checkout |
...
| [Devin](https://devin.ai/) [@devin_docs] (Cognition) | Cloud agent and desktop editor | Delegate a task to an isolated cloud machine and review the pull request (see [the harness landscape](agent-architecture.qmd#sec-ai-harness-landscape)) |
...
- **Local checkout.**
  ...
  at the cost of the hardware described in [running agents offline](local-models.qmd#sec-ai-offline).
- **Orchestration layer.**
...
Cognition's rebranding of that editor (measured 2026-09-09; see [the harness landscape](agent-architecture.qmd#sec-ai-harness-landscape)).

For licensing, token-cost characteristics, and a decision table for choosing among these tools,
see [the harness landscape](agent-architecture.qmd#sec-ai-harness-landscape);
