...
- *Recommendation*: **Enable** (see [best practices](coding-agents.qmd#sec-ai-best-practices) for safe usage guidelines)
...
(see [best practices](coding-agents.qmd#sec-ai-best-practices)).
